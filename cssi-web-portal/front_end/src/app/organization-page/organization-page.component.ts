...
export class OrganizationPageComponent implements OnInit{
  ...
  constructor(private route: ActivatedRoute, public dialog: MatDialog, private http: HttpClient) {} //makes an instance of the router
  ngOnInit(): void {
    ...
    this.http.get(this.base_url + '/userOrgAppList', {observe: 'response', responseType: 'json', params: param})
    .subscribe({
      next: (response) => {
